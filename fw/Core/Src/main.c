...
void PeriphCommonClock_Config(void)
{
  ...
  */
  PeriphClkInitStruct.PeriphClockSelection = RCC_PERIPHCLK_USB|RCC_PERIPHCLK_ADC
                              |RCC_PERIPHCLK_SPI2|RCC_PERIPHCLK_USART3;
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOD, EN_TRANSDUCER_Pin|EN_HEADPHONE_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : EN_TRANSDUCER_Pin EN_HEADPHONE_Pin */
  GPIO_InitStruct.Pin = EN_TRANSDUCER_Pin|EN_HEADPHONE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);

  /*Configure GPIO pin : USB_VBUS_DET_Pin */
  GPIO_InitStruct.Pin = USB_VBUS_DET_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(USB_VBUS_DET_GPIO_Port, &GPIO_InitStruct);
