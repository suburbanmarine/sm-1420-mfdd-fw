...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PB0     ------> ADC1_INP9
    */
    GPIO_InitStruct.Pin = AN_CURR_FB_Pin|AN_CURR_REF_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = AN_TRIMPOT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(AN_TRIMPOT_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END ADC2_MspInit 0 */
    ...
    PB1     ------> ADC2_INP5
    */
    GPIO_InitStruct.Pin = AN_RX_P_Pin|AN_RX_N_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = AN_RX_REF_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(AN_RX_REF_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB0     ------> ADC1_INP9
    */
    HAL_GPIO_DeInit(GPIOA, AN_CURR_FB_Pin|AN_CURR_REF_Pin);

    HAL_GPIO_DeInit(AN_TRIMPOT_GPIO_Port, AN_TRIMPOT_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PB1     ------> ADC2_INP5
    */
    HAL_GPIO_DeInit(GPIOC, AN_RX_P_Pin|AN_RX_N_Pin);

    HAL_GPIO_DeInit(AN_RX_REF_GPIO_Port, AN_RX_REF_Pin);
...
void HAL_DAC_MspInit(DAC_HandleTypeDef* hdac)
{
  ...
  /* USER CODE END DAC1_MspInit 0 */
    ...
    PA5     ------> DAC1_OUT2
    */
    GPIO_InitStruct.Pin = AN_GAIN_Pin|GPIO_PIN_5;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
    ...
    /* DAC1_CH2 Init */
    hdma_dac1_ch2.Instance = DMA2_Stream4;
...
void HAL_DAC_MspDeInit(DAC_HandleTypeDef* hdac)
{
  ...
  /* USER CODE END DAC1_MspDeInit 0 */
    ...
    PA5     ------> DAC1_OUT2
    */
    HAL_GPIO_DeInit(GPIOA, AN_GAIN_Pin|GPIO_PIN_5);
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM12_MspInit 0 */
    ...
    PB14     ------> TIM12_CH1
    */
    GPIO_InitStruct.Pin = EXT_DAC_nSYNC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_MEDIUM;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM12;
    HAL_GPIO_Init(EXT_DAC_nSYNC_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM12_MspDeInit 0 */
    ...
    PB15     ------> TIM12_CH2
    */
    HAL_GPIO_DeInit(GPIOB, EXT_DAC_nSYNC_Pin|GPIO_PIN_15);
